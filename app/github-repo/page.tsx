            ...
            <div className="mx-auto max-w-7xl">
                ...
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    {gitHubRepoData.map((item) => (
                        <article key={item.id} className="group rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400/30 hover:shadow-[0_20px_60px_rgba(34,211,238,0.15)]">
